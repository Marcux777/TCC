...
\toprule
\rowcolor{tablehead}
\textbf{Etapa preservada} & \textbf{Quantidade} & \textbf{Interpreta\c{c}\~ao adotada nesta pesquisa} \\
\midrule
...
\bottomrule
\end{tabularx}
\caption{Reconcilia\c{c}\~ao do fluxo de revis\~ao usado nesta pesquisa.}
...
\toprule
\rowcolor{tablehead}
\textbf{Reposit\'orio adjacente} & \textbf{Commit/tag local} & \textbf{Artefato principal} & \textbf{Evid\^encia aproveit\'avel neste trabalho} & \textbf{Limite de uso} \\
\midrule
...
\addlinespace
\url{truck-resource-orchestration-slr} & \texttt{f178dbc} & manuscrito da revis\~ao sistematizada & protocolo PRISMA, fronteira de validade, contagens por ambiente e limita\c{c}\~oes do corpus & artigo correlato; n\~ao substitui o referencial deste trabalho \\
\addlinespace
\url{Arxiv-Revisao-de-Literatura} & \texttt{1fc492b} & pacote editorial ampliado da revis\~ao & rubrica de fronteira, matriz QA recuperada, frequ\^encias do corpus e ap\^endices de auditoria & material de apoio; deve ser harmonizado com a vers\~ao deste trabalho antes de anexar \\
\bottomrule
\end{tabularx}
\caption{Reposit\'orios adjacentes do ecossistema PequiFlux e fun\c{c}\~ao de cada um neste trabalho.}
