...
O experimento principal comparativo, descrito nas matrizes da Se\c{c}\~ao~4.2, ser\'a executado no TCC~II. No entanto, em alinhamento com as diretrizes do Design Science Research, a viabilidade t\'ecnica do motor proposto j\'a foi demonstrada por \textit{prova por constru\c{c}\~ao}: o artefato foi instanciado preliminarmente em reposit\'orios adjacentes de desenvolvimento e valida\c{c}\~ao. A s\'intese detalhada desses resultados t\'ecnicos foi deslocada para a Tabela~\ref{tab:resultados-repos-adjacentes}, no Ap\^endice~\ref{apx:materiais-contextuais}. No corpo do cap\'itulo, o ponto substantivo \'e que a etapa atual j\'a possui prot\'otipo audit\'avel, benchmark RHFS validado, artefato congelado com trilha de reprodu\c{c}\~ao e revis\~ao sistematizada reconciliada; nenhum desses itens, isoladamente, substitui o teste confirmat\'orio de H1 \parencite{hevnerDesignScienceInformation2004a}.
...
\addlinespace
G\^emeos digitais & Estado observ\'avel, rastreabilidade e representa\c{c}\~ao digital no p\'os-colheita \parencite{dyckDigitalTwinsNovel2023}. & Exige hist\'orico de eventos e reconstru\c{c}\~ao posterior. & Informa governan\c{c}a e auditoria, sem reivindicar um g\^emeo digital completo. \\
\bottomrule
\end{longtable}
}
