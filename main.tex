...
\bottomrule
\end{tabularx}
\caption[S\'intese da lacuna te\'orica]{S\'intese da lacuna te\'orica que fundamenta o recorte da pesquisa.}
\end{table}
...
\caption[Compara\c{c}\~ao com a literatura]{Compara\c{c}\~ao direta entre motor proposto e as frentes da revis\~ao de literatura usadas na pesquisa.}\\
\toprule
\rowcolor{tablehead}
...
\bottomrule
\end{tabularx}
\caption[Taxonomia de restri\c{c}\~oes e eventos]{Taxonomia m\'inima de restri\c{c}\~oes e eventos considerada pelo artefato.}
\end{table}
...
\caption[Pseudoc\'odigo do motor de despacho]{Pseudoc\'odigo reprodut\'ivel do motor de despacho online proposto.}
...
\bottomrule
\end{tabularx}
\caption[Camadas de evid\^encia experimental]{Camadas de evid\^encia adotadas para manter o experimento autossuficiente.}
\end{table}
...
\bottomrule
\end{tabularx}
\caption[Modelagem de entrada do simulador]{Modelagem de entrada adotada no simulador antes do experimento principal.}
...
\bottomrule
\end{tabularx}
\caption[Matriz param\'etrica e de plausibilidade]{Matriz Param\'etrica e de Plausibilidade.}
...
\bottomrule
\end{tabularx}
\caption[Par\^ametros da pol\'itica de despacho]{Par\^ametros da pol\'itica definidos para reduzir ambiguidade de implementa\c{c}\~ao.}
...
\bottomrule
\end{tabularx}
\caption[Pol\'iticas do experimento principal]{Pol\'iticas do experimento principal. H1 ser\'a julgada contra FIFO \textit{flow-faithful}, prioridade + factibilidade local e despacho din\^amico por escore fixo; FIFO estrito fica como limite inferior te\'orico.}
...
\bottomrule
\end{tabularx}
\caption[Resultados parciais dos reposit\'orios adjacentes]{Resultados parciais aproveit\'aveis dos reposit\'orios adjacentes.}
...
\bottomrule
\end{tabular}
\caption[Ativa\c{c}\~ao da janela curta]{Diagn\'ostico de ativa\c{c}\~ao da janela curta, por estrato de congest\~ao. Verificado em cen\'arios de desenvolvimento antes do congelamento, sem compara\c{c}\~ao de desempenho entre pol\'iticas.}
\label{tab:diag-h}
\end{table}
...
\caption[Dispers\~ao entre throughput e espera]{Esqueleto do gr\'afico de dispers\~ao throughput versus espera. Cada ponto representar\'a uma semente de uma pol\'itica; a regi\~ao indicada funciona apenas como guia de interpreta\c{c}\~ao para menor espera sem recuo material de throughput, n\~ao como resultado antecipado. O formato segue a compara\c{c}\~ao por cen\'arios simulados e tempos operacionais em \textcite{neagoeUsingDiscreteeventSimulation2021a}.}
...
\bottomrule
\end{tabularx}
\caption[Estabilidade e prioridade mandat\'oria]{Esqueleto da tabela de estabilidade e viola\c{c}\~oes de prioridade mandat\'oria. A contagem bruta registra caminh\~oes que romperam o limiar operacional da classe mandat\'oria; os estratos de alta congest\~ao ser\~ao lidos como condi\c{c}\~oes de maior press\~ao operacional para pol\'iticas sem reavalia\c{c}\~ao por evento. A leitura dialoga com o KPI de percentual de caminh\~oes atendidos fora da janela em \textcite{dasilvaIntegrationMachineLearning2023}.}
...
\toprule
\rowcolor{tablehead}
\textbf{Atividade} & \shortstack{\textbf{Jun.}\\\textbf{26}} & \shortstack{\textbf{Jul.}\\\textbf{26}} & \shortstack{\textbf{Ago.}\\\textbf{26}} & \shortstack{\textbf{Set.}\\\textbf{26}} & \shortstack{\textbf{Out.}\\\textbf{26}} & \shortstack{\textbf{Nov.}\\\textbf{26}} & \shortstack{\textbf{Dez.}\\\textbf{26}} \\
\midrule
...
Reda\c{c}\~ao e consolida\c{c}\~ao dos resultados &  &  & \timeline & \timeline & \timeline & \timeline & \timeline \\
Revis\~ao com orientadora e ajustes finais &  &  &  &  &  & \timeline & \timeline \\
Prepara\c{c}\~ao da apresenta\c{c}\~ao e defesa &  &  &  &  &  &  & \timeline \\
\bottomrule
\end{tabular}
\caption[Cronograma da pesquisa]{Cronograma macro de execu\c{c}\~ao da pesquisa entre junho e dezembro de 2026 (TCC~I e TCC~II).}
\end{table}
...
\bottomrule
\end{tabularx}
\caption[Materiais pr\'evios da startup]{Materiais pr\'evios da startup e uso permitido nesta pesquisa.}
\end{table}
...
\bottomrule
\end{tabularx}
\caption[Reposit\'orios adjacentes do PequiFlux]{Reposit\'orios adjacentes do ecossistema PequiFlux e fun\c{c}\~ao de cada um neste trabalho.}
