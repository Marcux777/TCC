...
\begin{tikzpicture}[font=\small, >=Stealth]
  ...
  \node[align=center, text width=4.0cm, font=\tiny, text=pequiDark!75,
    ...
    {50 sementes pareadas por pol\'itica\\
     preenchimento ap\'os a execu\c{c}\~ao do simulador};
...
Os materiais anteriores de concep\c{c}\~ao e prototipagem registram a evolu\c{c}\~ao pr\'atica da ideia antes da avalia\c{c}\~ao experimental. Eles podem apoiar formula\c{c}\~ao do problema, valida\c{c}\~ao de face e rastreio de requisitos, mas n\~ao devem ser lidos como prova de desempenho do motor.
...
\toprule
\rowcolor{tablehead}
\textbf{Material contextual} & \textbf{Uso nesta pesquisa} \\
\midrule
...
\bottomrule
\end{tabularx}
\caption[Materiais pr\'evios de concep\c{c}\~ao]{Materiais pr\'evios de concep\c{c}\~ao e uso permitido nesta pesquisa.}
\end{table}
...
\midrule
Prot\'otipo de copiloto de p\'atio & \texttt{e671b9d} & prova de conceito execut\'avel do copiloto de p\'atio & hard constraints, UI, auditoria de decis\~ao, cen\'arios de exce\c{c}\~ao e relat\'orio sample com 20 cen\'arios & demonstra maturidade de engenharia; n\~ao valida H1 nem desempenho em campo \\
\addlinespace
...
\bottomrule
\end{tabularx}
\caption[Reposit\'orios adjacentes da pesquisa]{Reposit\'orios adjacentes da pesquisa e fun\c{c}\~ao de cada um neste trabalho.}
