...
Cada configura\c{c}\~ao ter\'a \textbf{50 repeti\c{c}\~oes} com sementes controladas, permitindo compara\c{c}\~oes pareadas entre o artefato e as pol\'iticas de refer\^encia. A an\'alise reportar\'a medianas, intervalo interquartil, diferen\c{c}as pareadas, teste de Wilcoxon signed-rank, estimador de Hodges--Lehmann e tamanho de efeito pareado $r_{rb}$. O estudo piloto de sanidade usar\'a 20\% das combina\c{c}\~oes; os 80\% restantes formar\~ao o conjunto principal. Antes do piloto ficam congelados $H$, limiares $\tau$, pesos do escore fixo, sementes, regra de rejei\c{c}\~ao, m\'etrica prim\'aria, margem de throughput e plano estat\'istico. O piloto n\~ao recalibra esses itens; corre\c{c}\~oes posteriores ficam restritas a implementa\c{c}\~ao ou exclus\~oes pr\'e-especificadas.
...
\midrule
Carga baixa & $\rho < 0{,}70$ & $N=60$, 3 moegas e 2 balan\c{c}as, nos quatro regimes & 4 & 200 pares \\
\addlinespace
M\'edia congest\~ao & $0{,}70 \leq \rho < 0{,}85$ & $N=60$ com 2 moegas e 1--2 balan\c{c}as; ou $N=60$, 3 moegas e 1 balan\c{c}a, nos quatro regimes & 12 & 600 pares \\
\addlinespace
Alta congest\~ao & $\rho \geq 0{,}85$ & demais combina\c{c}\~oes do plano fatorial & 56 & 2.800 pares \\
\bottomrule
\end{tabularx}
...
O protocolo separa fatos operacionais, hip\'oteses de calibra\c{c}\~ao e resultados observados. Al\'em do Wilcoxon signed-rank, o estudo reportar\'a mediana e IQR das diferen\c{c}as pareadas, Hodges--Lehmann, bootstrap pareado de 95\% e $r_{rb}$. Empates e diferen\c{c}as zero ser\~ao explicitados; se dominarem, o teste de sinais pareado entrar\'a como robustez. Cen\'arios de desenvolvimento, piloto e experimento principal permanecem separados antes da abertura dos resultados, impedindo que ajustes de conveni\^encia entrem depois de observada a compara\c{c}\~ao principal.
...
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.16}
\begin{tabularx}{\textwidth}{@{}C{0.13\textwidth}C{0.18\textwidth}C{0.15\textwidth}C{0.17\textwidth}C{0.15\textwidth}Y@{}}
\toprule
\rowcolor{tablehead}
\textbf{Inst\^ancia} & \textbf{Congest\~ao ($\rho$)} & \textbf{FIFO (LB) p95} & \textbf{Escore fixo p95} & \textbf{Motor p95} & \textbf{Gap motor vs. FIFO} \\
\midrule
$N=60$ & carga baixa & -- & -- & -- & -- \\
\addlinespace
$N=60$ & m\'edia congest\~ao & -- & -- & -- & -- \\
\addlinespace
$N=60$ & alta congest\~ao & -- & -- & -- & -- \\
\addlinespace
$N=120$ & carga baixa & -- & -- & -- & -- \\
\addlinespace
$N=120$ & m\'edia congest\~ao & -- & -- & -- & -- \\
\addlinespace
$N=120$ & alta congest\~ao & -- & -- & -- & -- \\
\addlinespace
$N=180$ & carga baixa & -- & -- & -- & -- \\
\addlinespace
$N=180$ & m\'edia congest\~ao & -- & -- & -- & -- \\
\addlinespace
$N=180$ & alta congest\~ao & -- & -- & -- & -- \\
\bottomrule
\end{tabularx}
\caption{Esqueleto da tabela de gap de espera p95. O gap ser\'a calculado como $100\cdot(\mathrm{p95}_{FIFO}-\mathrm{p95}_{Motor})/\mathrm{p95}_{FIFO}$, seguindo a l\'ogica de compara\c{c}\~ao percentual contra pol\'itica de refer\^encia usada por \textcite{fonsecaStabilityApproachCDC2025}. Carga baixa ser\'a lida como controle operacional; m\'edia e alta congest\~ao ser\~ao os estratos substantivos de H1.}
...
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.16}
\begin{tabularx}{\textwidth}{@{}C{0.13\textwidth}C{0.18\textwidth}C{0.17\textwidth}C{0.19\textwidth}Y@{}}
\toprule
\rowcolor{tablehead}
\textbf{Inst\^ancia} & \textbf{Congest\~ao ($\rho$)} & \textbf{FIFO: viola\c{c}\~oes} & \textbf{Escore fixo: viola\c{c}\~oes} & \textbf{Motor: viola\c{c}\~oes} \\
\midrule
$N=60$ & carga baixa & -- & -- & -- \\
\addlinespace
$N=60$ & m\'edia congest\~ao & -- & -- & -- \\
